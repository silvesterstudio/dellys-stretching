...
values
  ('adult', '4 ședințe',  '4 занятия',  4,  160, 'MDL', 30, 1),
  ('adult', '8 ședințe',  '8 занятий',  8,  280, 'MDL', 30, 2),
  ('adult', '12 ședințe', '12 занятий', 12, 360, 'MDL', 45, 3),
  ('child', '8 ședințe (copii)', '8 занятий (дети)', 8, 240, 'MDL', 30, 4)
